...
describe 'Visitant see ratings on buffet page' do
  it 'and see only last 3 ratings' do
    #arrange
    ...
    within("div#ratings") do
      ...
      expect(page).not_to have_content "Por: Matheus Bellucio"
      expect(page).not_to have_content "Muito legal"
