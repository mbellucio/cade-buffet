...
RSpec.describe Order, type: :model do
  context "#valid?" do
    ...
    describe "numericality" do
      it "false when predicted guests number is greater than event max_quorum" do
        #arrange
        ...
        #assert
        expect(order.errors.include? :predicted_guests).to be_truthy
        expect(order.errors[:predicted_guests]).to include(" deve ser menor ou igual ao máximo estipulado pelo evento")
      end
    end
    ...
    describe "random code" do
      ...
      it "and never changes" do
        ...
        #act
        order.update(event_details: "More details")
        #assert
